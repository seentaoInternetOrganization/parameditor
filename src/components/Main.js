...
class Main extends React.Component {
    ...
    componentDidUpdate(){
      ...
      Util.onChangedjson(changedData);
    }
    ...
    setChangedData(){
        ...
        console.log(this.state.testjson);
    }
    render() {
        const {type, isShowSave} = this.state;
        ...
        return (
            <div style={{width:480, height:320, overflowY:"auto", borderWidth:1, borderColor:"#F4A460", borderStyle:"solid", fontFamily:"droid sans mono, consolas, monospace, courier new, courier, sans-serif", fontWeight: "bold"}}>
                ...
                {editable&&isShowSave?<Button onClick={this.setChangedData.bind(this, {})} size="small" type="danger" style={{float:"right", marginRight:10}}>保存</Button>:null}
                </div>
